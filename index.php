...
<div class="row flex-lg-row-reverse align-items-center g-5 m-4"> 
  <div class="col-10 col-sm-8 col-lg-6"> 
    <img src="img/ferreteria.webp" class="d-block mx-lg-auto img-fluid rounded-4" alt="Bootstrap Themes" width="700" height="500" loading="lazy"> 
...
<div class="row g-4 py-5 row-cols-1 row-cols-lg-3 m-4"> 
  <div class="feature col"> 
    <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3 p-2 rounded-3"> 
...
<svg class="bi" aria-hidden="true">
 ...
 <div class="feature col"> 
  <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3 p-2 rounded-3"> 
    ...
    <svg class="bi" width="1em" height="1em" aria-hidden="true"><use xlink:href="#people-circle">
    </use>
  </svg>
 </div> 
 <h3 class="fs-2 text-body-emphasis">Featured title</h3> 
...
<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top"> 
  <div class="col-md-4 d-flex align-items-center">
    ...
    <span class="mb-3 mb-md-0 text-body-secondary">© 2026 Ferreteria Don Toño, Inc</span> 
  </div>
